---
title: Reducing Game of Buttholes: Will of the Prophets' Carbon Footprint
date: 2019-10-18 11:00:00 +0100
---

[Back in July I started looking seriously into the environmental impact of my work and the sites I run.](({% post_url 2019-07-21-green-web-dev %})) It's been a little while since I've done much work on this (mainly because I was lucky enough to have a two month holiday), but I remain comitted to the cause!

In this post, I'll explain some changes I've made to a site I run for the podcast [The Greatest Generation](http://gagh.biz) called [Game of Buttholes: The Will of the Prophets](http://gagh.biz/game). It's a simple snakes and ladders game played at the end of each episode, with special squares which instruct the hosts to do silly things when they record the next episode. [There's more information on it over here.](https://greatestgen.fandom.com/wiki/DS9_Board_Game_(Game_of_Buttholes))

Again, I'll look into the three sources of energy use:
